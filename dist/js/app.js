(() => {
    ...
    function initSliders() {
        if (document.querySelector(".mainpage-slider", ".body-mainpage-slider-mini")) {
            new core(".mainpage-slider", {
            ...
            new core(".body-mainpage-slider-mini", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
