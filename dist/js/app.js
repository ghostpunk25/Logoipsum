(() => {
    ...
    function initSliders() {
        if (document.querySelector(".mainslider__slider", ".our-specialists__slider")) {
    ...
    da.init();
    document.getElementById("one").onclick = myClickOne;
    function myClickOne() {
        const cityOne = document.getElementById("one").innerText;
        document.getElementById("1").innerHTML = cityOne;
    }
    document.getElementById("two").onclick = myClickTwo;
    function myClickTwo() {
        const cityTwo = document.getElementById("two").innerText;
        document.getElementById("1").innerHTML = cityTwo;
    }
    !function(e, t) {
