...
***************************************************************************** */
    ...
    if (menuSerch) menuSerch.addEventListener("click", (function(e) {
        if (menuSee) menuSee.classList.toggle("serchSee");
    }));
    const videBlock = document.querySelector(".video-block");
    const videoBlockTitle = document.querySelector(".video-block__title");
    if (videBlock) videBlock.addEventListener("click", (function(e) {
        if (videoBlockTitle) videoBlockTitle.classList.add("hidden");
    }));
    const exploreLinks = document.querySelector(".footer__button");
    const othersHidden = document.querySelector(".footer__others");
    if (exploreLinks) exploreLinks.addEventListener("click", (function(e) {
        if (othersHidden) othersHidden.classList.toggle("activeOne");
    }));
    ...
    if (contact) contact.addEventListener("click", (function(e) {
        if (itemsHidden) itemsHidden.classList.toggle("activeHidden");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
